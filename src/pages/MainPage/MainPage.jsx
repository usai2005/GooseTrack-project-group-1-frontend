  ...
  return (
    <>
      <AuthSection>
        <AuthContainer>
          <LogoImg
            srcSet={`${IMAGES.gooseLogoMob1x143} 142w, ${IMAGES.gooseLogoTabDesk1x150} 150w, ${IMAGES.gooseLogoTabDesk2x300} 300w, ${IMAGES.gooseLogoMob2x285} 285w,`}
            sizes="(min-width: 768px) 150px, (min-width: 1px) 142px, 100vw"
